...
public enum AutoPoints {
    ...
    PGPIntake3(new Vector2d(-55,-12), -Math.PI/2),
    ...
    GPPIntake3(new Vector2d(-55,-36), -Math.PI/2),
    ...
    LaunchRed(new Vector2d(10.0,20.0), -3*Math.PI/4),
    ...
    PGPIntake3Red(new Vector2d(55,-12), Math.PI/2),
    ...
    GPPIntake3Red(new Vector2d(55,-36), Math.PI/2),
