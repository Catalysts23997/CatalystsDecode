...
public enum AutoPoints {
    ...
    LaunchBlue(new Vector2d(-20,30.0), 3*Math.PI/4),
    EndBlue(new Vector2d(-54,33), Math.PI),
    ...
    EndRed(new Vector2d(54,33), Math.PI),

    PreIntakePPGRed(new Vector2d(25,12), Math.PI/2),
    PPGIntake1Red(new Vector2d(36.5,12), Math.PI/2),
    PPGIntake2Red(new Vector2d(41.5,12), Math.PI/2),
    PPGIntake3Red(new Vector2d(48,12), Math.PI/2),
