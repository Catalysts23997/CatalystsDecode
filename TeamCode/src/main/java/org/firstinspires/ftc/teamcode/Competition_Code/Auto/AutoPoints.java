...
public enum AutoPoints {
    ...
    PPGBlue(new Vector2d(-56,13), -Math.PI / 2, 0.4, 1.5),
    PrePPGRed(new Vector2d(25,12.5), Math.PI / 2),
    PPGRed(new Vector2d(56,12.5), Math.PI / 2, 0.4, 1.5),


    PrePGPBlue(new Vector2d(-25,-11.3), -Math.PI / 2),
    PGPBlue(new Vector2d(-61,-11.3), -Math.PI / 2, 0.4 , 1.5),
    PGPMidBlue(new Vector2d(-45,-11.3), 9 * Math.PI / 8),
    PGPBackBlue(new Vector2d(-25,-11.3), 9 * Math.PI / 8),
    PrePGPRed(new Vector2d(25,-11), Math.PI / 2),
    PGPRed(new Vector2d(61,-11), Math.PI / 2, 0.4, 1.5),
    PGPMidRed(new Vector2d(45,-11), -9 * Math.PI / 8),
    PGPBackRed(new Vector2d(25,-11), -9 * Math.PI / 8),

    PreGPPBlue(new Vector2d(-23,-33.5), -Math.PI / 2),
    GPPBlue(new Vector2d(-61,-33.5), -Math.PI / 2, 0.4, 1.5),
    GPPBackBlue(new Vector2d(-23,-33.5), 9*Math.PI / 8),
    PreGPPRed(new Vector2d(23,-34), Math.PI / 2),
    GPPRed(new Vector2d(61,-34), Math.PI / 2, 0.4, 1.5),
