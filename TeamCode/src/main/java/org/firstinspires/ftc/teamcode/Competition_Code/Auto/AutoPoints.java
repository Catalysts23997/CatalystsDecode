...
public enum AutoPoints {
    ...
    AprilTagBlue(new Vector2d(20,-50), 3*Math.PI/32),
    LaunchBlue(new Vector2d(10,-20.0), 1*Math.PI/4),
    EndBlue(new Vector2d(54,-33), Math.PI/2),

    PreIntakePPG(new Vector2d(25,-12), Math.PI),
    PPGIntake1(new Vector2d(36.5,-12), Math.PI),
    PPGIntake2(new Vector2d(41.5,-12), Math.PI),
    PPGIntake3(new Vector2d(48,-12), Math.PI),

    PreIntakePGP(new Vector2d(25,12), Math.PI),
    PGPIntake1(new Vector2d(36.5,12), Math.PI),
    PGPIntake2(new Vector2d(41.5,12), Math.PI),
    PGPIntake3(new Vector2d(48,12), Math.PI),
